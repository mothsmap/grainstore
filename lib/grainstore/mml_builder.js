...
MMLBuilder.prototype.baseMML = function() {
    ...
    var layernames = Array.isArray(this.params.name) ? this.params.name : [ this.params.name ];
    
    var mml   = {};
    mml.srs   = '+init=epsg:' + this.grainstore_map.srid;
    mml.format = this.grainstore_map.format || 'png';
    mml.minzoom = this.grainstore_map.minzoom || 0;
    mml.maxzoom = this.grainstore_map.minzoom || 19;
